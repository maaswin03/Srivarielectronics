        ...
        <div className="AboutUs-2 AboutUs-3">
          <div className="AboutUs-5">
            ...
            <p>
              ...
              professionals, we became Authorized Distributors of Nimbus Lights
              in 2014, offering high-quality and customizable electrical
              products, including lights, fans, and more, while continuing to
              deliver innovative and efficient solutions for homes, businesses,
              and industries.
            </p>
